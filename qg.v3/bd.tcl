...
proc create_root_design { parentCell } {
    ...
    # Create instance: axi_ic_HP & sfp_ic_HP, and set properties
    set axi_ic_HP [                                     \
        create_bd_cell                                  \
            -type ip                                    \
    ...
    # Create instance: axi_ic_GP & sfp_ic_GP, and set properties
    set axi_ic_GP [                                     \
        create_bd_cell                                  \
            -type ip                                    \
            -vlnv xilinx.com:ip:axi_interconnect:2.1    \
        axi_ic_GP ]
    set_property CONFIG.NUM_MI {4} $axi_ic_GP
    set sfp_ic_GP [                                     \
        create_bd_cell                                  \
            -type ip                                    \
            -vlnv xilinx.com:ip:axi_interconnect:2.1    \
    ...
    # create axi_ethernet_idelay_ctrl
    create_bd_cell                                      \
            -type ip                                    \
    ...
    #PLGE1
    connect_bd_intf_net -intf_net axi_dma1_m_axi_sg     \
        [get_bd_intf_pins axi_dma1/M_AXI_SG]            \
        [get_bd_intf_pins axi_ic_HP/S00_AXI]
    connect_bd_intf_net -intf_net axi_dma1_m_axi_mm2s   \
        [get_bd_intf_pins axi_dma1/M_AXI_MM2S]          \
        [get_bd_intf_pins axi_ic_HP/S01_AXI]
    connect_bd_intf_net -intf_net axi_dma1_m_axi_s2mm   \
        [get_bd_intf_pins axi_dma1/M_AXI_S2MM]          \
        [get_bd_intf_pins axi_ic_HP/S02_AXI]
    connect_bd_intf_net -intf_net axi_dma1_m_axis_mm2s  \
        [get_bd_intf_pins axi_dma1/M_AXIS_MM2S]         \
        [get_bd_intf_pins axi_ethernet1/s_axis_txd]
    connect_bd_intf_net -intf_net axi_dma1_m_axis_cntrl \
        [get_bd_intf_pins axi_dma1/M_AXIS_CNTRL]        \
        [get_bd_intf_pins axi_ethernet1/s_axis_txc]

    connect_bd_intf_net -intf_net axi_ethernet1_axis_rxd\
        [get_bd_intf_pins axi_ethernet1/m_axis_rxd]     \
        [get_bd_intf_pins axi_dma1/S_AXIS_S2MM]
    connect_bd_intf_net -intf_net axi_ethernet1_axis_rxs\
        [get_bd_intf_pins axi_ethernet1/m_axis_rxs]     \
        [get_bd_intf_pins axi_dma1/S_AXIS_STS]
    connect_bd_intf_net -intf_net axi_ethernet1_gmii    \
        [get_bd_intf_pins axi_ethernet1/gmii]           \
        $gmii1
    connect_bd_intf_net -intf_net axi_ethernet1_mdio    \
        [get_bd_intf_pins axi_ethernet1/mdio]           \
        $mdio1

    #PLGE2
    connect_bd_intf_net -intf_net axi_dma2_m_axi_sg     \
        [get_bd_intf_pins axi_dma2/M_AXI_SG]            \
        [get_bd_intf_pins axi_ic_HP/S03_AXI]
    connect_bd_intf_net -intf_net axi_dma2_m_axi_mm2s   \
        [get_bd_intf_pins axi_dma2/M_AXI_MM2S]          \
        [get_bd_intf_pins axi_ic_HP/S04_AXI]
    connect_bd_intf_net -intf_net axi_dma2_m_axi_s2mm   \
        [get_bd_intf_pins axi_dma2/M_AXI_S2MM]          \
        [get_bd_intf_pins axi_ic_HP/S05_AXI]
    connect_bd_intf_net -intf_net axi_dma2_m_axis_mm2s  \
        [get_bd_intf_pins axi_dma2/M_AXIS_MM2S]         \
        [get_bd_intf_pins axi_ethernet2/s_axis_txd]
    connect_bd_intf_net -intf_net axi_dma2_m_axis_cntrl \
        [get_bd_intf_pins axi_dma2/M_AXIS_CNTRL]        \
        [get_bd_intf_pins axi_ethernet2/s_axis_txc]

    connect_bd_intf_net -intf_net axi_ethernet2_axis_rxd\
        [get_bd_intf_pins axi_ethernet2/m_axis_rxd]     \
        [get_bd_intf_pins axi_dma2/S_AXIS_S2MM]
    connect_bd_intf_net -intf_net axi_ethernet2_axis_rxs\
        [get_bd_intf_pins axi_ethernet2/m_axis_rxs]     \
        [get_bd_intf_pins axi_dma2/S_AXIS_STS]
    connect_bd_intf_net -intf_net axi_ethernet2_gmii    \
        [get_bd_intf_pins axi_ethernet2/gmii]           \
        $gmii2
    connect_bd_intf_net -intf_net axi_ethernet2_mdio    \
        [get_bd_intf_pins axi_ethernet2/mdio]           \
        $mdio2
    ...
    connect_bd_intf_net -intf_net sfp_dma1_m_axis_mm2s  \
        ...
        [get_bd_intf_pins axi_ethernet_sfp0/s_axis_txd]
    connect_bd_intf_net -intf_net sfp_dma1_m_axis_cntrl \
        [get_bd_intf_pins sfp_dma1/M_AXIS_CNTRL]        \
        [get_bd_intf_pins axi_ethernet_sfp0/s_axis_txc]

    connect_bd_intf_net -intf_net axi_ethernet_sfp0_axis_rxd \
        [get_bd_intf_pins axi_ethernet_sfp0/m_axis_rxd] \
        [get_bd_intf_pins sfp_dma1/S_AXIS_S2MM]
    connect_bd_intf_net -intf_net axi_ethernet_sfp0_axis_rxs \
        [get_bd_intf_pins axi_ethernet_sfp0/m_axis_rxs] \
        [get_bd_intf_pins sfp_dma1/S_AXIS_STS]
    connect_bd_intf_net -intf_net axi_ethernet5_sfp0    \
        [get_bd_intf_ports sfp0]                        \
        [get_bd_intf_pins axi_ethernet_sfp0/sfp]
    connect_bd_net -net xlconstant_val1_dout            \
        [get_bd_pins axi_ethernet_sfp0/signal_detect]   \
        [get_bd_pins xlconstant_val1/dout]

    # ic_HP Master ports
    connect_bd_intf_net -intf_net axi_ic_HP_M00_AXI     \
        [get_bd_intf_pins axi_ic_HP/M00_AXI]            \
    ...
    #axi_ic_GP
    connect_bd_intf_net -intf_net axi_ic_GP_M00_AXI     \
        [get_bd_intf_pins axi_ic_GP/M00_AXI]            \
        [get_bd_intf_pins axi_dma1/S_AXI_LITE]
    connect_bd_intf_net -intf_net axi_ic_GP_M01_AXI     \
        [get_bd_intf_pins axi_ic_GP/M01_AXI]            \
        [get_bd_intf_pins axi_ethernet1/s_axi]
    connect_bd_intf_net -intf_net axi_ic_GP_M02_AXI     \
        [get_bd_intf_pins axi_ic_GP/M02_AXI]            \
        [get_bd_intf_pins axi_dma2/S_AXI_LITE]
    connect_bd_intf_net -intf_net axi_ic_GP_M03_AXI     \
        [get_bd_intf_pins axi_ic_GP/M03_AXI]            \
    ...
    connect_bd_intf_net -intf_net sfp_ic_GP_M01_AXI     \
        ...
        [get_bd_intf_pins axi_ethernet_sfp0/s_axi]
    ...
    connect_bd_intf_net -intf_net processing_system7_1_m_axi_gp0    \
        ...
        [get_bd_intf_pins axi_ic_GP/S00_AXI]
    ...
    # interrupts
    connect_bd_net -net axi_dma1_s2mm_introut           \
        [get_bd_pins axi_dma1/s2mm_introut]             \
        [get_bd_pins concat_intr/In0]
    connect_bd_net -net axi_dma1_mm2s_introut           \
        [get_bd_pins axi_dma1/mm2s_introut]             \
        [get_bd_pins concat_intr/In1]
    connect_bd_net -net axi_ethernet1_interrupt         \
        [get_bd_pins axi_ethernet1/interrupt]           \
        [get_bd_pins concat_intr/In2]

    connect_bd_net -net axi_dma2_s2mm_introut           \
        [get_bd_pins axi_dma2/s2mm_introut]             \
        [get_bd_pins concat_intr/In3]
    connect_bd_net -net axi_dma2_mm2s_introut           \
        [get_bd_pins axi_dma2/mm2s_introut]             \
        [get_bd_pins concat_intr/In4]
    connect_bd_net -net axi_ethernet2_interrupt         \
    ...
    connect_bd_net -net axi_ethernet_sfp0_interrupt     \
        [get_bd_pins axi_ethernet_sfp0/interrupt]       \
        [get_bd_pins concat_intr/In8]

    # RESET
    connect_bd_net -net axi_dma1_mm2s_prmry_reset_out_n \
        [get_bd_pins axi_dma1/mm2s_prmry_reset_out_n]   \
        [get_bd_pins axi_ethernet1/axi_txd_arstn]
    connect_bd_net -net axi_dma1_mm2s_cntrl_reset_out_n \
        [get_bd_pins axi_dma1/mm2s_cntrl_reset_out_n]   \
        [get_bd_pins axi_ethernet1/axi_txc_arstn]
    connect_bd_net -net axi_dma1_s2mm_prmry_reset_out_n \
        [get_bd_pins axi_dma1/s2mm_prmry_reset_out_n]   \
        [get_bd_pins axi_ethernet1/axi_rxd_arstn]
    connect_bd_net -net axi_dma1_s2mm_sts_reset_out_n   \
        [get_bd_pins axi_dma1/s2mm_sts_reset_out_n]     \
        [get_bd_pins axi_ethernet1/axi_rxs_arstn]

    connect_bd_net -net axi_dma2_mm2s_prmry_reset_out_n \
        [get_bd_pins axi_dma2/mm2s_prmry_reset_out_n]   \
        [get_bd_pins axi_ethernet2/axi_txd_arstn]
    connect_bd_net -net axi_dma2_mm2s_cntrl_reset_out_n \
        [get_bd_pins axi_dma2/mm2s_cntrl_reset_out_n]   \
        [get_bd_pins axi_ethernet2/axi_txc_arstn]
    connect_bd_net -net axi_dma2_s2mm_prmry_reset_out_n \
        [get_bd_pins axi_dma2/s2mm_prmry_reset_out_n]   \
        [get_bd_pins axi_ethernet2/axi_rxd_arstn]
    connect_bd_net -net axi_dma2_s2mm_sts_reset_out_n   \
        [get_bd_pins axi_dma2/s2mm_sts_reset_out_n]     \
    ...
    connect_bd_net -net RESET_BLOCK_ic_aresetn          \
        ...
        [get_bd_pins axi_ic_HP/S01_ARESETN]             \
        [get_bd_pins axi_ic_HP/S02_ARESETN]             \
        [get_bd_pins axi_ic_HP/S03_ARESETN]             \
        [get_bd_pins axi_ic_HP/S04_ARESETN]             \
        [get_bd_pins axi_ic_HP/S05_ARESETN]             \
    ...
    connect_bd_net -net RESET_BLOCK_ic_aresetn1         \
        [get_bd_pins RESET_BLOCK/ic_aresetn1]           \
        [get_bd_pins axi_dma1/axi_resetn]               \
        [get_bd_pins axi_ethernet1/s_axi_lite_resetn]   \
        [get_bd_pins axi_dma2/axi_resetn]               \
        [get_bd_pins axi_ethernet2/s_axi_lite_resetn]   \
        [get_bd_pins sfp_dma1/axi_resetn]               \
        [get_bd_pins axi_ethernet_sfp0/s_axi_lite_resetn] \
        [get_bd_pins axi_ic_GP/ARESETN]                 \
        [get_bd_pins axi_ic_GP/S00_ARESETN]             \
        [get_bd_pins axi_ic_GP/M00_ARESETN]             \
        [get_bd_pins axi_ic_GP/M01_ARESETN]             \
        [get_bd_pins axi_ic_GP/M02_ARESETN]             \
        [get_bd_pins axi_ic_GP/M03_ARESETN]             \
...
# clock
    connect_bd_net -net processing_system7_1_fclk_clk0  \
        ...
        [get_bd_pins axi_dma1/m_axi_sg_aclk]            \
        [get_bd_pins axi_dma1/m_axi_mm2s_aclk]          \
        [get_bd_pins axi_dma1/m_axi_s2mm_aclk]          \
        [get_bd_pins axi_ethernet1/axis_clk]            \
        [get_bd_pins axi_dma2/m_axi_sg_aclk]            \
        [get_bd_pins axi_dma2/m_axi_mm2s_aclk]          \
        [get_bd_pins axi_dma2/m_axi_s2mm_aclk]          \
        ...
        [get_bd_pins axi_ethernet_sfp0/axis_clk]        \
        [get_bd_pins axi_ic_HP/ACLK]                    \
        [get_bd_pins axi_ic_HP/M00_ACLK]                \
        [get_bd_pins axi_ic_HP/S00_ACLK]                \
        [get_bd_pins axi_ic_HP/S01_ACLK]                \
        [get_bd_pins axi_ic_HP/S02_ACLK]                \
        [get_bd_pins axi_ic_HP/S03_ACLK]                \
        [get_bd_pins axi_ic_HP/S04_ACLK]                \
        [get_bd_pins axi_ic_HP/S05_ACLK]                \
    ...
    connect_bd_net -net processing_system7_1_fclk_clk1  \
        ...
        [get_bd_pins axi_ic_GP/ACLK]                    \
        [get_bd_pins axi_ic_GP/S00_ACLK]                \
        [get_bd_pins axi_ic_GP/M00_ACLK]                \
        [get_bd_pins axi_ic_GP/M01_ACLK]                \
        [get_bd_pins axi_ic_GP/M02_ACLK]                \
        [get_bd_pins axi_ic_GP/M03_ACLK]                \
    ...
    connect_bd_intf_net -intf_net mgt0_in_clk           \
        ...
        [get_bd_intf_pins axi_ethernet_sfp0/mgt_clk]
